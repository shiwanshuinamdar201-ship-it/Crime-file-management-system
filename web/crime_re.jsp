...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Online Online Crime File Management System</title>
        <link href="css/styles.css" rel="stylesheet" type="text/css" />
        <%
            if (request.getParameter("msg") != null) {
        %>
        <script>alert('Informer info add successfully..');</script>
        <%            }
        %>
        <%
    ...
    <body>
        <div class="menu-wrapper">
            <div class="menu">
                <ul>
                    ...
                    <li><a href="crime_re.jsp"  class="active">Crime Report</a></li>
        ...
        <div id="contentinfo">
            <!--==============================body start=================================-->
            <br><br><center><h2 style="font-size: 26px; color: #ffffff; font-family: cursive">Witness Report</h2>
                        <br><form action="login.jsp" method="get"> 
                                <table>
                                    <tr>
                                        <td>
                                            <label style="font-size: 20px; color: window">Suspect Name : </label>
                                        </td>
                                        <td>
                                            <input type="text" class="inputs" name="sname" required="" placeholder="Your Name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label style="font-size: 20px; color: window">Informer name : </label>
                                        </td>
                                        <td>
                                            <input type="text" class="inputs" name="iname" required="" placeholder="Your Name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label style="font-size: 20px; color: window">Informer Address : </label>
                                        </td>
                                        <td>
                                            <input type="text" class="inputs" name="iadd" required="" placeholder="Your Name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <textarea rows="4" cols="" name="idis" class="inputs" placeholder="Description"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="date" class="inputs" name="dateofre" required="" placeholder="Your Name" />
