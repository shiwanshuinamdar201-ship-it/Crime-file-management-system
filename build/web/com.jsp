...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        %>
        <script>alert('Complaint added successfully..');</script>
        <%            }
        %>
        <%
    ...
    <body>
        <div class="menu-wrapper">
            <div class="menu">
                <ul>
                    ...
                    <li><a href="com.jsp"  class="active">Complaint</a></li>
        ...
        <div id="contentinfo">
            <!--==============================body start=================================-->
            <br><br><center><h2 style="font-size: 26px; color: #ffffff; font-family: cursive">Add Complaint</h2>
                        <br><form action="login.jsp" method="get"> 
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="inputs" name="uname" required="" placeholder="Your Name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="inputs" name="d_suspect" required="" placeholder="Detail of Suspect" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <label style="font-size: 20px; color: window">Date of Complaint : </label>
                                        </td>
                                        <td>
                                            <input type="date" class="inputs" name="dateoc" required="" placeholder="Your Name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
