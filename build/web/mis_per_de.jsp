...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="menu-wrapper">
            <div class="menu">
                <ul>
                    ...
                    <li><a href="mis_per_de.jsp" class="active">Missing</a></li>
        ...
        <div id="contentinfo">
            <!--==============================body start=================================-->
            <br><br><center><h2 style="font-size: 26px; color: white; font-family: cursive">Missing Person Details</h2>
                        <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                                <tr>
                                    ...
                                    <th style="text-align: center;width: 400px;  font-size: 16px; color: #5b6a7d">Missing Place</th>
                                    <th style="text-align: center;width: 200px;  font-size: 16px; color: #5b6a7d">Missing Date</th>
                                    ...
                                    <th style="text-align: center;width: 200px;  font-size: 16px; color: #5b6a7d">Address of Missing Person</th>
                                    ...
                                    <th style="text-align: center;width: 200px;  font-size: 16px; color: #5b6a7d">FIR</th>
                                </tr>
                                <tr>
                                    <%
                                        Connection con = null;
                                        ...
                                        try {
                                            ...
                                            rs = st.executeQuery("select * from missperson");
                                            while (rs.next()) {
                                    ...
                                    <td style="font-size: 16px; color: white"><br><%=rs.getString("mplace")%></td>  
                                    <td style="font-size: 16px; color: white"><br><%=rs.getString("misdate")%></td>  
                                    ...
                                    <td style="font-size: 16px; color: white"><br><%=rs.getString("addomiss")%></td>   
                                    <td style="font-size: 16px; color: white"><br><%=rs.getString("dateofreport")%></td>
                                    <td style="font-size: 16px; color: white"><br><img width="180" height="180" src="viewimage.jsp?id=<%=rs.getString("id")%>"/></td>
                                    <td><a href="fir.jsp?id=<%=fir%>"><font style="color: green; font-size: 16px">FIR</a></td>
                                </tr>
                                <%
